...
class GroupFields { 
	...
	/** Delivery.Number INTEGER */
       ...
       /** PublicExternalData STRING */
       /** PublicExternalData */
       /** @var string PublicExternalData */
       const PublicExternalData = "PublicExternalData";

		/** PublicExternalDataAsXML STRING */
		/** PublicExternalDataAsXML */
		/** @var string PublicExternalDataAsXML */
       const PublicExternalDataAsXML = "PublicExternalData.Xml";
